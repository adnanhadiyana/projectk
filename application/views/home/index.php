                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="product-list.html" class="nav-item nav-link">Profile Company</a>
                    ...
                    <div class="col-md-6">
                        <div class="header-slider normal-slider">
                            <div class="header-slider-item">
                                <img src="<?= base_url(); ?>assets/img/3.jpg" alt="Slider Image" />
        ...
        <div class="brand">
            <div class="container-fluid">
                <div class="brand-slider">
                    <div class="brand-item"><img src="<?= base_url(); ?>assets/img/1.png" alt=""></div>
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img src="<?= base_url(); ?>assets/img/1.jpg" alt="Product Image">
                                </a>
                ...
                <div class="row payment align-items-center">
                    <div class="col-md-6">
                        <div class="payment-method">
                            <h2>We Accept:</h2>
                            <img src="<?= base_url(); ?>assets/img/payment-method.png" alt="Payment Method" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="payment-security">
                            <h2>Secured By:</h2>
                            <img src="<?= base_url(); ?>assets/img/godaddy.svg" alt="Payment Security" />
                            <img src="<?= base_url(); ?>assets/img/norton.svg" alt="Payment Security" />
                            <img src="<?= base_url(); ?>assets/img/ssl.svg" alt="Payment Security" />
                        </div>
                    </div>
                </div>
            </div>
